...
* Montana Mendy will be doing a demonstration showing the difference of build speed for the Travis CI Arm CI/CD builds on Equinix Metal in contrast with the legacy architecture, the builds are now 50% faster on the Ampere Altra servers, so you do you want to blink or you might miss it!
